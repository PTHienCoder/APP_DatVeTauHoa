...
namespace ServerMain
{
    ...
    class DBconnection
    {
        ...
        public bool ThemChuyenTau(string tenchuyentau, string ngaykhoihanh, string thoigiandi, string gaden, string gadi, string matau, string sovetoida, string soluongvecho1nguoi, string giave, string CN)
        {
            ...
            {
                CNhanh = "CN0";
               bool k1 = ThemChuyenTau0(tenchuyentau, ngaykhoihanh, thoigiandi, gaden, gadi, matau, sovetoida, soluongvecho1nguoi, giave, CNhanh);
                if (k1 == true)
                    return true;
                else
                    return false;
            ...
            {
                CNhanh = "CN1";
                bool k1 = ThemChuyenTau1(tenchuyentau, ngaykhoihanh, thoigiandi, gaden, gadi, matau, sovetoida, soluongvecho1nguoi, giave, CNhanh);
                if (k1 == true)
                    return true;
                else
                    return false;
            ...
            {
                CNhanh = "CN2";
                bool k1 = ThemChuyenTau2(tenchuyentau, ngaykhoihanh, thoigiandi, gaden, gadi, matau, sovetoida, soluongvecho1nguoi, giave, CNhanh);
                if (k1 == true)
                    return true;
                else
                    return false;
        ...
        public bool ThemChuyenTau0(string tenchuyentau, string ngaykhoihanh, string thoigiandi, string gaden, string gadi, string matau, string sovetoida, string soluongvecho1nguoi, string giave, string CN)
        {
            ...
            SqlConnection con = new SqlConnection(strConnectionString0);
            con.Open();
            ...
            command.Parameters.AddWithValue("@macn", CN);
        ...
        public bool ThemChuyenTau2(string tenchuyentau, string ngaykhoihanh, string thoigiandi, string gaden, string gadi, string matau, string sovetoida, string soluongvecho1nguoi, string giave, string CN)
        {
            ...
            SqlConnection con = new SqlConnection(strConnectionString2);
            con.Open();
            SqlCommand command = new SqlCommand();
            command.CommandType = CommandType.Text;
            command.CommandText = sql;
        ...
        public bool ThemChuyenTau1(string tenchuyentau, string ngaykhoihanh, string thoigiandi, string gaden, string gadi, string matau, string sovetoida, string soluongvecho1nguoi, string giave, string CN)
        {
            ...
            SqlConnection con = new SqlConnection(strConnectionString1);
            con.Open();
            SqlCommand command = new SqlCommand();
            command.CommandType = CommandType.Text;
            command.CommandText = sql;
        ...
        public bool CheckChuyentau(string tenct)
        {

            try { 
            
                string query = "SELECT Count(*) as DEM FROM ChuyenTau WHERE TenChuyenTau='" + tenct + "'";
        ...
        public DataTable GetDataEdit(int flag)
        {
            if (flag == 1)
            {
                ...
                for (int i = 0; i < data.Rows.Count; i++)
                {
                    ...
                    NewRow["NgayDi"] = Command_Main.Encrypt_Decrypt_DataBase.DataBase_Decrypt(key, data.Rows[i]["NgayDi"].ToString(), true);
        ...
        public bool UpdateProfile(int id, string name, string diachi, string phone, string email)
        {
            ...
            string sql = "UPDATE NguoiDung SET TenDayDu=@ten,DiaChi=@adress,SoDienThoai=@phone,Email=@email WHERE [Id]='" + id + "'";
        ...
        public bool Capnhatchuyentau(int mact, string tenchuyentau, string ngaykhoihanh, string thoigiandi, string gaden, string gadi, string matau, string sovetoida, string soluongvecho1nguoi, string giave)
        {

            string Tenchuyentau = tenchuyentau;
            string Ngaykhoihanh = Command_Main.Encrypt_Decrypt_DataBase.DataBase_Encrypt(key, ngaykhoihanh, true);
            string Thoigiandi = Command_Main.Encrypt_Decrypt_DataBase.DataBase_Encrypt(key, thoigiandi, true);
            string Soluongvecho1nguoi = Command_Main.Encrypt_Decrypt_DataBase.DataBase_Encrypt(key, soluongvecho1nguoi, true);
            string soluongvetoida = Convert.ToString(sovetoida);
            //   string sql = " Insert Into Chuyentau (Tenchuyentau,ThoigianChay,GaDi,GaDen,SoVeToiDa,MaTau,NgayDi,SoLuongVe,GiaVe,MaCN) values(@Tenchuyentau,@Thoigiandi,@gadi,@gaden,@soluongvetoida,@matau,@Ngaykhoihanh,@Soluongvecho1nguoi,@giave,@macn)";
